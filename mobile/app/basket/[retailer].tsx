              ...
              <GlassCard key={`${request?.id ?? index}:${product?.id ?? "none"}`} strong style={styles.itemCard}>
                  ...
                  <View style={styles.matchBlock}>
                    <View style={styles.matchHeader}>
                      ...
                      <View style={styles.strongPill}>
                        <MaterialCommunityIcons name="check" size={13} color={colors.emerald} />
                        <Text style={styles.strongPillText}>{product.confidence === "high" ? "Strong match" : "Compatible match"}</Text>
                      </View>
                    </View>
                ...
                {result.alternatives.length > 0 ? (
                  <View style={styles.alternatives}>
                    <Text style={styles.alternativesTitle}>Other verified candidates</Text>
...
const styles = StyleSheet.create({
  ...
  strongPill: { flexDirection: "row", alignItems: "center", gap: 4, borderRadius: radius.pill, backgroundColor: "rgba(114,221,162,0.18)", paddingHorizontal: 8, paddingVertical: 5 },
